 ...
 */
@Repository
public class TblAperturaManualCabinaBDaoImpl extends HibernateDaoSupport implements TblAperturaManualCabinaBDao {
    
    private static final Logger LOGGER = Logger.getLogger(TblAperturaManualCabinaBDaoImpl.class);
    
    @Autowired
    public TblAperturaManualCabinaBDaoImpl(SessionFactory factoryCabinaB) {
        super.setSessionFactory(factoryCabinaB);
    }
