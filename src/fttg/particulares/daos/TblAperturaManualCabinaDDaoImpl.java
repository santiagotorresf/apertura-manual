 ...
 */
@Repository
public class TblAperturaManualCabinaDDaoImpl extends HibernateDaoSupport implements TblAperturaManualCabinaDDao {
    
    private static final Logger LOGGER = Logger.getLogger(TblAperturaManualCabinaDDaoImpl.class);
    
    @Autowired
    public TblAperturaManualCabinaDDaoImpl(SessionFactory factoryCabinaD) {
        super.setSessionFactory(factoryCabinaD);
    }
    @Override
