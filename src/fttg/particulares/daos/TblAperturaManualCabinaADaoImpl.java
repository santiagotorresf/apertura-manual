 ...
 */
@Repository
public class TblAperturaManualCabinaADaoImpl extends HibernateDaoSupport implements TblAperturaManualCabinaADao {

    private static final Logger LOGGER = Logger.getLogger(TblAperturaManualCabinaADaoImpl.class);

    @Autowired
    public TblAperturaManualCabinaADaoImpl(SessionFactory factoryCabinaA) {
        super.setSessionFactory(factoryCabinaA);
    }
